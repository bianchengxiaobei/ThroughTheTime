...
public class _2dxFX_ColorRGB : MonoBehaviour
{
	...
	{	
		...
		if (ActiveChange)
		{
			...
			GetComponent<Renderer>().sharedMaterial.SetFloat("_ColorR", _ColorR);
			GetComponent<Renderer>().sharedMaterial.SetFloat("_ColorG", _ColorG);
			GetComponent<Renderer>().sharedMaterial.SetFloat("_ColorB", _ColorB);
