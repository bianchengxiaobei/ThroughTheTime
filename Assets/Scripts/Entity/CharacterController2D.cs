...
public class CharacterController2D : RaycastController
{
    ...
    public void Move(Vector2 moveAmount, bool isFly,bool standingOnPlatform = false)
    {
        Move(moveAmount, Vector2.zero, isFly, standingOnPlatform);
    }

    public void Move(Vector2 moveAmount, Vector2 input,bool isFly ,bool standingOnPlatform = false)
    {
    ...
    public void Rotate(int faceDir)
    {
        if (faceDir > 0)
        {
